...
####### EXPORTED PROFILE FROM SDK VERSION 5.10 AT 2012-12-07 21:16:57 ########
...
MESSAGE_TYPES = {
    ...
    55: MessageType(
        ...
        fields={
            ...
            253: Field(  # Must align to logging interval, for example, time must be 00:00:00 for daily log.
                name='timestamp',
                type=FIELD_TYPES['date_time'],
                def_num=253,
                scale=None,
